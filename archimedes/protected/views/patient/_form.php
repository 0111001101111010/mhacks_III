...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'user_specific_client'); ?>
		<?php echo $form->textField($model,'user_specific_client',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'user_specific_client'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'state', CHtml::listData(State::model()->findAll(), 'id', 'name'), array('empty'=>'')); ?>
